...
exports.chat = async (req, res) => {
  try {
    ...
    const sessionContext = {
      ...
      budgetIntent: newSessionContext.budgetIntent || legacyContext.budgetIntent || null,
      travelPurpose: newSessionContext.travelPurpose || legacyContext.travelPurpose || null,
      preferences: Array.isArray(newSessionContext.preferences)
        ? newSessionContext.preferences
        : (Array.isArray(legacyContext.preferences) ? legacyContext.preferences : []),
      lastHotel: newSessionContext.lastHotel || legacyContext.lastHotel || null,
      lastTool: newSessionContext.lastTool || legacyContext.lastTool || null
    }
